...
//    public boolean isCached(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType) {
	public boolean isCached(String requestUrl, String cacheTag) {
		throwIfNotOnMainThread();

//        String cacheKey = getCacheKey(requestUrl, maxWidth, maxHeight, scaleType);
		String cacheKey = getCacheKey(requestUrl, cacheTag);
	...
	public ImageContainer get(String requestUrl, final ImageListener listener, String cacheTag) {
		return get(requestUrl, listener, 0, 0, cacheTag);
	}
	
	public ImageContainer get(String requestUrl, final ImageListener listener, ScaleType scaleType, String cacheTag) {
		return get(requestUrl, listener, 0, 0, scaleType, cacheTag);
	}
	...
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight, String cacheTag) {
		return get(requestUrl, imageListener, maxWidth, maxHeight, ScaleType.CENTER_INSIDE, null, false, cacheTag);
	}
	
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight, ProcessListener processListener, String cacheTag) {
		return get(requestUrl, imageListener, maxWidth, maxHeight, ScaleType.CENTER_INSIDE, processListener, false, cacheTag);
	}
	
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight, ScaleType scaleType, String cacheTag) {
		return get(requestUrl, imageListener, maxWidth, maxHeight, scaleType, null, false, cacheTag);
	}
	
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight, ProcessListener processListener, boolean clip, String cacheTag) {
		return get(requestUrl, imageListener, maxWidth, maxHeight, ScaleType.CENTER_INSIDE, processListener, clip, cacheTag);
	}
	 ...
	 */
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight, ScaleType scaleType, ProcessListener processListener, boolean clip, String cacheTag) {

		// only fulfill requests that were initiated from the main thread.
		throwIfNotOnMainThread();

		final String cacheKey = getCacheKey(requestUrl, cacheTag);
		...
		// network and
		// track it.
		Request<Bitmap> newRequest = makeImageRequest(requestUrl, maxWidth, maxHeight, scaleType, cacheKey, processListener, clip,cacheTag);
	...
	protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, 
			final String cacheKey, ProcessListener processListener, boolean clip, String cacheTag) {
