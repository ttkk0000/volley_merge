...
public class ImageRequest extends Request<Bitmap> {
	...
	public ImageRequest(String url, Response.Listener<Bitmap> listener, int maxWidth, int maxHeight, Config decodeConfig, Response.ErrorListener errorListener, ProcessListener processListener, boolean clip) {
	...
	protected void deliverResponse(Bitmap response) {
		Log.d("TTT", "volley response: " + (response == null ? "" : response.toString()));
